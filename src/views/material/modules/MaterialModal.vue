                ...
                <a-form-item :labelCol="{xs: { span: 24 },sm: { span: 4 }}"
                  ...
                  <a-row class="form-row" :gutter="24">
                    ...
                    <a-col :lg="15" :md="15" :sm="24">
                      <a-input placeholder="输入单位" :hidden="unitStatus" v-decorator.trim="[ 'unit' ,validatorRules.unit]"
                               @change="onlyUnitOnChange"/>
                      <a-select :value="unitList" placeholder="选择单位" v-decorator="[ 'unitId' ]"
                                @change="manyUnitOnChange"
                                showSearch optionFilterProp="children" :hidden="manyUnitStatus"
...
<!--                                        </div>-->
                                        ...
                                        <a-select-option value="此代发价为不含税运价格，集采默认不含运（偏远地区运费另算）" >
                                          此代发价为不含税价格（偏远地区运费另算）
                                        </a-select-option>
                                      </a-select>
                </a-form-item>
...
<script>
  ...
  import {queryMaterialCategoryTreeList,checkMaterial,checkMaterialBarCode,getAllMaterialAttribute,getMaxBarCode,findBySelectSup} from '@/api/api'
