    ...
    data () {
      return {
        ...
        materialTable: {
          ...
          dataSource: [],
          columns: [
            { title: '产品编码', key: 'barCode', width: '8%', type: FormTypes.popupJsh, kind: 'material', multi: true,
            ...
            { title: '发票类别', key: 'taxRateType', width: '8%', type: FormTypes.select,placeholder: '请选择',
